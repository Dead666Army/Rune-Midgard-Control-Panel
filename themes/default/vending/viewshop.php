        ...
        <table class="horizontal-table">
            <thead>
                <tr>
                    ...
                    <th><?php echo Flux::message('ItemRefine') ?></th>
                    <th><?php echo Flux::message('ItemSlot') ?></th>
                    <th><?php echo Flux::message('ItemCard0') ?></th>
                    <th><?php echo Flux::message('ItemCard1') ?></th>
                    <th><?php echo Flux::message('ItemCard2') ?></th>
                    <th><?php echo Flux::message('ItemCard3') ?></th>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($item->card0 && ($item->type == 4 || $item->type == 5) && $item->card0 != 254 && $item->card0 != 255 && $item->card0 != -256): ?>
                                ...
                                <?php endif ?>
                            <?php else: ?>
                                <span class="not-applicable"><?php echo Flux::message('ListNoneF') ?></span>
                            <?php endif ?>
                        </td>
                        <td>
