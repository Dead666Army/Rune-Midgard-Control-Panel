...
<?php foreach ($characters as $serverName => $chars): $zeny = 0; ?>
	...
	<table class="vertical-table">
		...
		<tr>
			<td align="center"><?php echo $char->char_num+1 ?></td>
			<td>
			...
			<td align="center"><?php echo (int)$char->base_level ?></td>
			<td align="center"><?php echo (int)$char->job_level ?></td>
...
<?php if ($items): ?>
	...
	<table class="vertical-table">
		...
		<tr>
			...
			<td align="center"><?php echo number_format($item->amount) ?></td>
			<td align="center">
