...
<p><?php printf(htmlspecialchars(Flux::message('AccountCreateInfo')), '<a href="https://cp.rune-midgard.com/?module=pages&action=content&path=reglement">'.Flux::message('AccountCreateTerms').'</a>') ?></p>
...
<?php endif ?>
<p><strong>Note:</strong> <?php echo sprintf(Flux::message('PasswordLength'), Flux::config('MinPasswordLength'), Flux::config('MaxPasswordLength')) ?></p>
