...
<h2><?php echo htmlspecialchars(Flux::message('RankingZeny')) ?></h2>
<h3>
	<?php echo htmlspecialchars(sprintf(Flux::message('RankingZenyTop'), number_format($limit=(int)Flux::config('ZenyRankingLimit')))) ?>
...
<table class="horizontal-table">
	<tr>
		...
		<th><?php echo Flux::message('RankingZenyLabel')?></th>
	...
	<tr<?php if (!isset($chars[$i])) echo ' class="empty-row"'; if ($i === 0) echo ' class="top-ranked" title="'. sprintf(Flux::message('RankingZenyPopup'),htmlspecialchars($chars[$i]->char_name),$topRankType).'"' ?>>
