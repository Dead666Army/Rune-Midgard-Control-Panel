...
<h2><?php echo htmlspecialchars(Flux::message('RankingAlchimist')) ?></h2>
<h3>
	<?php echo htmlspecialchars(sprintf(Flux::message('RankingAlchimistTop'), number_format($limit=(int)Flux::config('AlchemistRankingLimit')))) ?>
...
<table class="horizontal-table">
	...
	<tr<?php if (!isset($chars[$i])) echo ' class="empty-row"'; if ($i === 0) echo ' class="top-ranked" title="'. sprintf(Flux::message('RankingAlchimistPopup'),htmlspecialchars($chars[$i]->char_name),$topRankType).'"' ?>>
