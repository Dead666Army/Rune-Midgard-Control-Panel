...
<h2><?php echo htmlspecialchars(Flux::message('RankingBlacksmith')) ?></h2>
<h3>
	<?php echo htmlspecialchars(sprintf(Flux::message('RankingBlacksmithTop'), number_format($limit=(int)Flux::config('BlacksmithRankingLimit')))) ?>
...
<table class="horizontal-table">
	<tr>
		...
		<th><?php echo Flux::message('RankingFame')?></th>
	...
	<tr<?php if (!isset($chars[$i])) echo ' class="empty-row"'; if ($i === 0) echo ' class="top-ranked" title="'. sprintf(Flux::message('RankingBlacksmithPopup'),htmlspecialchars($chars[$i]->char_name),$topRankType).'"' ?>>
