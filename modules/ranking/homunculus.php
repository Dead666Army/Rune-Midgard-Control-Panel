...
$col  = "hm.name AS homun_name, hm.char_id AS owner, ch.name AS owner_name, hm.class AS homun_class, hm.intimacy, hm.level, hm.exp, ";
...
$sql .= "LEFT JOIN {$server->charMapDatabase}.`char` ch ON ch.homun_id = hm.homun_id ";
