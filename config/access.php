...
return array(
	...
	'modules' => array(
		...
		'donate'    => array(
			...
			'notify'   => AccountLevel::LOWGM,
			'update'   => AccountLevel::LOWGM,
			'complete' => AccountLevel::LOWGM,
			'history'  => AccountLevel::NORMAL,
			'trusted'  => AccountLevel::NORMAL
		),
		'purchase'  => array(
			'index'    => AccountLevel::LOWGM,
			'add'      => AccountLevel::LOWGM,
			'clear'    => AccountLevel::LOWGM,
			'cart'     => AccountLevel::LOWGM,
			'checkout' => AccountLevel::LOWGM,
			'remove'   => AccountLevel::LOWGM,
			'pending'  => AccountLevel::LOWGM
		),
		'itemshop'  => array(
		...
		'ranking'	=> array(
			...
			'swordman'		=> AccountLevel::LOWGM,
			'bowman'		=> AccountLevel::LOWGM,
			'spearman'		=> AccountLevel::LOWGM,
