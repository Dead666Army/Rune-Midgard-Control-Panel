...
return array(
	'ServerAddress'				=> 'cp.rune-midgard.com',// This value is the hostname:port under which Flux runs. (e.g., example.com or example.com:80)
	'BaseURI'					=> '',						// The base URI is the base web root on which your application lies.
	'InstallerPassword'			=> '1R3$iw0M8Ty^',	// Installer/updater password.
	...
	'DefaultLanguage'			=> 'en_en',					// Specify the default control panel language (see FLUX_ROOT/lang/ directory for available languages.)
	'SiteTitle'					=> 'RuneMidgard',			// This value is only used if the theme decides to use it.
	...
	'DateDefaultTimezone'		=> 'Europe/Paris',			// The default timezone, consult the PHP manual for valid timezones: http://php.net/timezones (null for defaut system TZ)
	...
	'ResultsPerPage'			=> 50,						// The number of results to display in a paged set, per page.
	'PagesToShow'				=> 20,						// The number of page numbers to display at once.
	'PageJumpMinimumPages'		=> 0,						// Minimum number of required pages before page jump box is shown. (0 to always show!)
	...
	'MailerFromAddress'			=> 'RuneMidgardOnline@gmail.com',// The e-mail address displayed in the From field.
	'MailerFromName'			=> 'Rune-Midgard',			// The name displayed with the From e-mail address.
	...
	'MailerSMTPUsername'		=> 'RuneMidgardOnline@gmail.com',// When MailerUseSMTP is true: Authorized username for SMTP server.
	...
	'PayPalBusinessEmail'		=> 'runemidgardonline@gmail.com',// Enter the e-mail under which you have registered your business account.
	'PayPalReceiverEmails'		=> array(					// These are the receiver e-mail addresses who are allowed to receive payment.
		'runemidgardonline@gmail.com',
	),
	...
	'GStorageLeaderOnly'		=> true,					// Only allow guild leader to view guild storage rather than all members?
	...
	'HoldUntrustedAccount'		=> 2,						// This is the time in hours to hold a donation crediting process for, if the account
															// isn't a trusted account. Specify 0 or false to disable this feature.
	'AutoUnholdAccount'			=> true,					// Enable this to auto-unhold an account and credit it if the transaction is still
...
// Discord Webhooks
	...
	'MenuItems'		=> array(
		'MainMenuLabel'		=> array(
			...
			'ForumLabel'		=> array('exturl' => 'https://forum.rune-midgard.com/'),	// External forum link
			'NewsLabel'			=> array('exturl' => 'https://rune-midgard.com/'),	//https://rune-midgard.com/
			'DownloadsLabel'	=> array('module' => 'pages','action'=>'content&path=downloads'),
			'RulesLabel'		=> array('module' => 'pages','action'=>'content&path=reglement'),
		),
		'AccountLabel'		=> array(
		...
		'ServerInformationLabel'	=> array(
			...
			'InformationLabel'		=> array('module' => 'pages','action'=>'content&path=information'),
			'InstancesLabel'		=> array('module' => 'pages','action'=>'content&path=instances'),
			'StaffLabel'		=> array('module' => 'pages','action'=>'content&path=staff'),
		),	
		'LiveInformationLabel'	=> array(
		...
		'SocialLabel'		=> array(
			...
			'RateUsOnRMSLabel'		=> array('exturl' => 'http://ratemyserver.net/index.php?page=detailedlistserver&serid=20369&url_sname=Rune%20Midgard'),
			'RateUsOnRoTopLabel'	=> array('exturl' => 'https://www.rotopserv.net/serveurs/rune-midgard-1/vote'),
		),
		'Service Desk'	=> array(
