...
return array(	
    ...
    'LiveInformationLabel'    => 'Live Information',
    'ServerInformationLabel'  => 'Server Information',
    ...
    'RateUsOnRoTopLabel'            => 'Rate us on Ro Top!',
	...
	'WoeInfo'                 => "Below are the WoE hours for %s. ",
	...
	//Other
    'LogginInfo'            => 'You are connected as <strong><a href="%s" title="View account">%s</a></strong> on %s' ,
    'ServerAdressInfo'      => 'Change <strong>server adress</strong> in the settings' ,
    'NewsInfo'              => 'by %s on %s',
    'PasswordLength'        => 'Your password must be between %d and %d chars.',
    'WhosOnlineLabelTitre'  => 'Who is online?' ,
    'WhosOnlineLabelDesc'   => 'Who is online on %s.' ,
    'WhosOnlineLabelEmpty'  => 'No character found on %s. <a href="javascript:history.go(-1)">Back</a>.' ,
    'HiddenFromList'        => '%d people decided not to be shown on this list.' ,
    'ButtonSearch'          => 'Search' ,
    'ButtonReset'           => 'Clear' ,
    'SDRequired'            => 'Mandatory field' ,
    'SDDescription'         => 'Brief description of the issue' ,
    'SDWhatHappened'        => 'Tell us what happened' ,
    'SDAdditionalInfo'      => 'Complementary informations' ,
    'SDScreenshot'          => 'Proof (Screenshot)' ,
    'SDChatlog'             => 'Chatlog' ,
    'SDVideo'               => 'Proof (Video)' ,
    'SDAllChar'             => 'All chars' ,
    'SDNoChar'              => 'No char' ,
    'SDBody'                => 'Description' ,
    'SDResponseby'          => 'Answered by' ,
    'SDResponse'            => 'Answer' ,
    'SDResponsePH'          => 'Click here to answer' ,
    'SDResponseAction'      => 'Action' ,
    'SDResponseTimestamp'   => 'Date' ,
    'SDResponseNone'        => 'No answer at the moment' ,
    'SDAddReply'            => 'Add an answer' ,
    'SDCreate'              => 'Create ticket' ,
    'DonateTitle'           => 'Donate' ,
    'DonateSubTitle'        => 'By donating, you\'re supporting the costs of <em>running</em> this server and <em>maintaining</em> it.  In return, you will be rewarded <span class="keyword">donation credits</span> that you may use to purchase items from our in-game shop.' ,
    'DonateReady'           => 'Are you ready to donate?' ,
    'DonatePaypalexplain'   => 'All donations towards us are received by PayPal, but don\'t worry!  Even if you don\'t have an account with PayPal, you can still use your credit card to donate!' ,
    'DonatePaypalexplain2'  => 'Once the credits are added to your account, you will be able to exchange them from the in-game NPC located in the building South-East of the prontera fountain.' ,
    'DonateHold1'           => 'To prevent fraudulent payments, our server currently locks the crediting process for',
    'DonateHold2'           => '%d hours' ,
    'DonateHold3'           => 'after the donation has been made to ensure legitimate gameplay and a healthy PayPal reputation.' ,
    'DonateHold4'           => 'This hold is applied only once for the associated PayPal e-mail and RO account.' ,
    'DonateRate'            => 'Current Credit Exchange Rate' ,
    'DonateMinimum'         => 'Minimum Donation Amount' ,
    'DonateSet'             => 'Enter an amount you would like to donate:' ,
    'DonateSetOr'           => 'or' ,
    'DonateCredit'          => 'Credits' ,
    'DonateConfirm'         => 'Confirm amount' ,
    'DonateAmount'          => 'Amount' ,
    'DonateConfirmReady1'   => 'When y\'re ready to donate, click the big “Donate” button to proceed with your transaction.' ,
    'DonateConfirmReady2'   => '(You can choose to donate from your existing PayPal balance or use your credit card if you don\'t have an account).' ,
    'DonateResetAmount'     => '(Reset Amount)' ,
    'DonateHistoryTitle'    => 'Donation history',
    'DonateHistoryCompleted' => 'Transactions: Completed',
    'DonateHistoryCompletedNb' => 'You have %d completed transaction(s).',
    'DonateHistoryTransaction' => 'Transaction',
    'DonateHistoryDate'     => 'Payment Date',
    'DonateHistoryEmail'    => 'E-mail',
    'DonateHistoryAmount'   => 'Amount',
    'DonateHistoryCurrency' => 'Currency',
    'DonateHistoryCompletedNone' => 'You have no completed transactions.',
    'DonateHistoryHeld'     => 'Transactions: Held',
    'DonateHistoryHeldNb'   => 'You have %d held transaction(s).',
    'DonateHistoryHeldDelay' => '↳ Hold Until:',
    'DonateHistoryHeldNone' => 'You have no held transactions.',
    'DonateHistoryFailed'   => 'Transactions: Failed',
    'DonateHistoryFailedNb' => 'You have %d failed transaction(s).',
    'DonateHistoryFailedNone' => 'You have no failed transactions.',
    'DonateTrusted'         => 'Trusted PayPal E-mails',
    'DonateTrustedNone'     => 'You do not have any trusted PayPal e-mail addresses.',
    'DonateTrustedDate'     => 'Date/Time Established',
    'DonateTrustedSubtitle1' => 'Below is a list of your trusted PayPal e-mail addresses.',
    'DonateTrustedSubtitle2' => 'Trusted e-mails do not undergo any holding process, therefore donations made by them will allow you to receive your credits <strong>instantly</strong>.',
    'DonateTrustedExplain'  => 'This is most likely because the credit holding system is currently <strong>not in effect</strong>, which means a donation made from any e-mail address is immediately accredited.',
    'ListNoneF'             => 'None',
    'ListNoneM'             => 'None',
    'ListHidden'            => 'Hidden',
    'PreferencesNotFound'   => 'No character found. <a href="javascript:history.go(-1)"Back</a>.',
    'PreferencesHidechar'   => 'Hide from "Who\'s Online"',
    'PreferencesHidemap'    => 'Hide current map from "Who\'s Online"',
    'PreferencesHideZeny'   => 'Hide from "Zeny Ranking"',
    'PreferencesHidecharExplain' => 'This will hide %s from "Who\'s Online".',
    'PreferencesHidemapExplain' => 'This will hide %s\'s current map from "Who\'s Online".',
    'PreferencesHideZenyExplain' => 'This will hide %s from "Zeny Ranking" page.',
    'PreferencesTitle'      => 'Preferences',
    'PreferencesSubtitle'   => 'Preferences for %s on %s',
    'PreferencesButton'     => 'Update preferences',
    'PreferencesModified'   => 'Preferences correctly updated.',
    'PreferencesModifiedFailed' => 'Preferences update failed.',
    'MapStatTitle'          => 'Map statistic',
    'MapStatSubtitle'       => 'This will show how many player are on each map.',
    'MapStatNbPlayers'      => '<strong>%d</strong> Players found',
    'MapStatNbMaps'         => 'on <strong>%d</strong> maps.',
    'MapStatPlayers'        => 'player(s)',
    'MapStatNone'           => 'No player found. <a href="javascript:history.go(-1)">Back',
    'RankingCharacterLabel' => 'character',
    'RankingCharacter'      => 'Character ranking',
    'RankingTop'            => '%d best characters',
    'RankingOn'             => 'On %s',
    'RankingFilterLabel'    => 'Filter by class:',
    'RankingAll'            => 'All',
    'RankingFilter'         => 'Filter',
    'RankingRank'           => 'Rank',
    'RankingBaseExp'        => 'Base Experience',
    'RankingJobExp'         => 'Job Experience',
    'RankingPopup'          => '<strong>%s</strong> is the best %s!',
    'RankingDeath'          => 'Death ranking',
    'RankingDeathTop'       => '%d most dead players',
    'RankingDeathLabel'     => 'Deaths',
    'RankingDeathPopup'     => '<strong>%s</strong> is the most killed %s!',
    'RankingAlchimist'      => 'Alchemist ranking',
    'RankingAlchimistTop'   => '%d best alchemists',
    'RankingAlchimistPopup' => '<strong>%s</strong> is the best %s!',
    'RankingFame'           => 'Points',
    'RankingBlacksmith'     => 'Blacksmith ranking',
    'RankingBlacksmithTop'  => '%d best Blacksmiths',
    'RankingBlacksmithPopup' => '<strong>%s</strong> is the best %s!',
    'RankingHomunculus'     => 'Homunculus ranking',
    'RankingHomunculusTop'  => '%d best Homonculus',
    'RankingHomunculusLabel' => 'Homunculus',
    'RankingHomunculusOwner' => 'Owner',
    'RankingHomunculusIntimacy' => 'Intimacy',
    'RankingHomunculusLevel' => 'Level',
    'RankingHomunculusExp'  => 'Experience',
    'RankingHomunculusPopup' => '<strong>%s</strong> is the best %s!',
    'RankingHomunculusNone' => 'There is no Homonculus. <a href="javascript:history.go(-1)">Back</a>.',
    'RankingGuild'          => 'Guilds ranking',
    'RankingGuildTop'       => '%d best guilds',
    'RankingGuildLevel'     => 'Guild Level',
    'RankingGuildCastle'    => 'Castle owned',
    'RankingGuildMembers'   => 'Members',
    'RankingGuildAvgLevel'  => 'Average Level',
    'RankingGuildExp'       => 'Experience',
    'RankingGuildPopup'     => '<strong>%s</strong> is the best guild!',
    'RankingGuildNone'      => 'No guilds found. <a href="javascript:history.go(-1)">Back</a>.',
    'RankingZeny'           => 'Zeny ranking',
    'RankingZenyTop'        => '%d richest players',
    'RankingZenyLabel'      => 'Zeny',
    'RankingZenyPopup'      => '<strong>%s</strong> is the richest %s!',
    'Vendor'                => 'Sellers',
    'VendorID'              => 'Seller ID',
    ...
    'VendorMap'             => 'Map',
    'VendorGender'          => 'Gender',
    'VendorNone'            => 'No seller found. <a href="javascript:history.go(-1)">Back</a>.',
    'VendorViewTitle'       => 'Vending Items Of ',
    'VendorViewNone'        => 'No seller found',
    'ItemTitle'             => 'Items',
    'ItemName'              => 'Name',
    'ItemRefine'            => 'Refine',
    'ItemSlot'              => 'Slot',
    ...
    'ItemLocation'          => 'Slot',
    'ItemBuy'               => 'Buy to NPC',
    'ItemSell'              => 'Sell to NPC',
    'ItemEqual'             => 'Equal to',
    'ItemGreater'           => 'Greater than',
    'ItemLess'              => 'Lower than',
    'ItemWeight'            => 'Weight',
    'ItemRange'             => 'Range',
    'ItemSlots'             => 'Slots',
    ...
    'ItemUnknown'           => 'Unknown',
    'ItemAmount'            => 'Amount',
    'ItemNone'              => 'No item found. <a href="javascript:history.go(-1)">Back</a>.',
    'ItemView'              => 'Item view',
    'ItemIdentifier'        => 'Identifier',
    'ItemNotForSale'        => 'Not for sale',
    'ItemCashShop'          => 'Credit price',
    'ItemMinEquip'          => 'Min equip',
    'ItemWeaponLevel'       => 'Weapon Level',
    'ItemEquipUpper'        => 'Upper',
    'ItemEquipJobs'         => 'Required class',
    'ItemEquipJobsAll'      => 'All',
    'ItemEquipJobsAllNovice' => 'All except novice',
    'ItemEquipJobsGender'   => 'Gender',
    'ItemEquipJobsGenderMale' => 'Male',
    'ItemEquipJobsGenderFemale' => 'Female',
    'ItemEquipJobsGenderBoth' => 'Male / Female',
    'ItemScript'            => 'Script',
    'ItemScriptEquip'       => 'Script equip',
    'ItemScriptUnEquip'     => 'Script unequip',
    'ItemDescription'       => 'Description',
    'ItemDroppedBy'         => 'Dropped by',
    'MonsterTitle'          => 'Monsters',
    ...
    'MonsterMVP'            => 'MVP!',
    'BuyingTitle'           => 'Buyer',
    'BuyingName'            => 'Buyer\'s name',
    'BuyingID'              => 'Buyer\'s ID',
    'BuyingNone'            => 'No buyer found. <a href="javascript:history.go(-1)">Back</a>.',
    'BuyingViewTitle'       => 'Buyer Items Of',
    'BuyingViewNone'        => 'No buyer found.',
);
?>
